...
class LoginPage(BasePage):
    ...
    def verificar_texto_mensagem_erro_login(self, texto_esperado):
        texto_econtrado = self.pegar_texto_elemento(self.error_message_login)
        assert texto_econtrado == texto_esperado, f"O texto encontrado foi '{texto_econtrado}', mas era esperado o texto '{texto_esperado}'"